...
{
      17,     0,    -1,     3,    13,    18,    19,    20,    23,    14,
      -1,    -1,     4,    15,     9,    -1,    -1,     5,    15,     9,
      -1,     6,    13,    21,    14,    -1,    -1,    21,    22,    -1,
       7,    15,     9,     8,    15,     9,    -1,    10,    13,    24,
      14,    -1,    -1,    24,    25,    -1,    11,    15,     9,    12,
      15,     9,    -1
};
...
{
  "$end", "error", "$undefined", "PROC", "START", "END", "IO", "BLOCK", 
  "TIME", "NUM", "MEM", "PAGE", "WRITE", "'{'", "'}'", "'='", "$accept", 
  "input", "start", "end", "ios", "io_lines", "io_line", "mems", 
  "mem_lines", "mem_line", 0
};
#endif
...
{
       0,     0,     0,     3,     1,     0,     5,     0,     0,     0,
       4,     0,     0,     0,     6,     8,     0,     0,     0,    12,
       2,     0,     7,     9,     0,     0,     0,    11,    13,     0,
       0,     0,     0,     0,     0,    10,     0,    14
};
...
{
      -1,    -8,     3,     2,   -11,    -6,     5,     4,    -4,     6,
     -11,     7,    -5,     8,   -11,   -11,     1,     9,    -7,   -11,
     -11,     0,   -11,   -11,   -10,    10,    11,   -11,   -11,    12,
      13,    14,    15,    16,    17,   -11,    19,   -11
};
...
{
      21,    26,     1,     4,    27,     3,     5,    22,    15,     7,
       8,    11,    12,    10,    19,    25,    14,     0,    16,    29,
      31,     0,    32,    20,     0,    35,    30,    34,    37,    33,
       0,     0,    36
};

static const yysigned_char yycheck[] =
{
       7,    11,     3,     0,    14,    13,     4,    14,    13,    15,
       5,    15,     6,     9,    13,    15,     9,    -1,    10,     9,
       8,    -1,     9,    14,    -1,     9,    15,    12,     9,    15,
      -1,    -1,    15
};
...
{
       0,     3,    17,    13,     0,     4,    18,    15,     5,    19,
       9,    15,     6,    20,     9,    13,    10,    23,    21,    13,
      14,     7,    14,    22,    24,    15,    11,    14,    25,     9,
      15,     8,     9,    15,    12,     9,    15,     9
};
...
#line 34 "parser.y"
  ...
  case 4:
#line 37 "parser.y"
    {data->start_time=yyvsp[0];;}
    break;

  case 6:
#line 40 "parser.y"
    {data->end_time=yyvsp[0];;}
    break;
...
#line 47 "parser.y"
    {
				data->io_events = g_renew(simul_io_event_t,
							data->io_events,
							++n_io_events);
				data->io_events[n_io_events-1].time=yyvsp[0];
				data->io_events[n_io_events-1].block=yyvsp[-3];
				;}
    break;
...
#line 60 "parser.y"
    {
				data->pages = g_renew(simul_mem_t,
							data->pages,
							++n_pages);
				data->pages[n_pages-1].page=yyvsp[-3];
				data->pages[n_pages-1].write=yyvsp[0];
				;}
    break;
